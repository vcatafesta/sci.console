...
def Mensagem( String, Color, nLine, nCol, centralizar )
	...
	Do case
		case nLine == nil .and. nLinhas = 0	
			return(AlertaPy(string + ';-;;', Color, centralizar, nOK))
		case nLine == nil .and. nLinhas > 0
			return(AlertaPy(string, Color, centralizar, nOK))		
		case nLine != nil .and. nLinhas > 0			
			return(AlertaPy(string, Color, centralizar, nOK))
...
def AlertPy(string, cor, centralizar, nOK)
******************************************
	AlertaPy(string, cor, centralizar, nOK)
	return nil

def AlertaPy(string, cor, centralizar, nOK)
***********************************************
	LOCAL cok     := " Ok "
   LOCAL nlinhas := strcount(';', string)
...
********************************
def LINBUTTON3(Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7, Arg8, ;
	Arg9, Arg10, Arg11)
