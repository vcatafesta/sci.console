...
WHILE OK
   ...
   if     nNivel = SCI_EXCLUSAO_DE_REGISTROS
	...
	elseif nNivel = SCI_ALTERACAO_DE_REGISTROS
      ...
      if !cRetorno
         cRetorno := TIniNew( oAmbiente:xBaseDados + "\" + cNome + ".INI"):ReadBool('permissao','PodeAlterarRegistros', FALSO )
      endif
		...
		WHILE Recemov->(Eval(oBloco))
			...
			Recemov->(Aadd( oReceposi:xTodos,;
							  { /*01*/ Docnr,;
								 ...
								 /*10*/ Codi,;
								 /*11*/ xObs,;
								 /*12*/ DateToStr(xDataPag)+DateToStr(Vcto)+Docnr,;
								 /*13*/ DateToStr(Vcto)+Docnr,;
								 /*14*/ DateToStr(xDataPag)+DateToStr(Vcto),;
								 /*15*/ Fatura,;
								 /*16*/ xDataPag,;
								 /*17*/ lAtivo,;
								 /*18*/ Recno(),;
								 /*19*/ DateToStr(xDataPag)+Docnr+DateToStr(Vcto),;
								 /*20*/ DateToStr(xDataPag)+Fatura+Docnr+DateToStr(Vcto),;
								 /*21*/ DateToStr(xDataPag)+Right(Docnr,8)+DateToStr(Vcto),;
								 /*22*/ DateToStr(xDataPag)+codi+Right(Docnr,8)+DateToStr(Vcto),;
								 /*23*/ xId,;
								 /*24*/ VlrOrigina,;								 
								 }))
			Recemov->(DbSkip(1))
	...
	WHILE Recebido->(Eval(oBloco2))
		...
		Recebido->(Aadd( oReceposi:xTodos,;
              		{  /*01*/ Docnr,;
							...
							/*10*/ Codi,;
							/*11*/ Obs,;
							/*12*/ DateToStr(DataPag)+DateToStr(Vcto)+Docnr,;
							/*13*/ DateToStr(Vcto)+Docnr,;
							/*14*/ DateToStr(DataPag)+DateToStr(Vcto),;
							/*15*/ Fatura,;
							/*16*/ Datapag,;
                     /*17*/ lAtivo,;
                     /*18*/ Recno(),;
							/*19*/ DateToStr(DataPag)+Docnr+DateToStr(Vcto),;
							/*20*/ DateToStr(DataPag)+Fatura+Docnr+DateToStr(Vcto),;
							/*21*/ DateToStr(DataPag)+Right(Docnr,8)+DateToStr(Vcto),;
							/*22*/ DateToStr(DataPag)+codi+Right(Docnr,8)+DateToStr(Vcto),;
							/*23*/ xId,;
							/*24*/ xVlrOrigina,;								 
						}))
		nConta++
